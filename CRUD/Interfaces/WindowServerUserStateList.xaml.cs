...
namespace Desktop___interfaces.Interfaces
{
    ...
    public partial class WindowServerUserStateList : Window
    {
        ...
        {
            ListView.ItemsSource = SqlUserServerState.GetAll(listOrder,null,null, nPag , 10);
        ...
        private void RefreshListView(int order)
        {
            ...
            ListView.ItemsSource = SqlUserServerState.GetAll(order, TextBoxFrom.Text, TextBoxUntil.Text, nPag, 10);    // Reassocia a listAlunos à ListView
        }
