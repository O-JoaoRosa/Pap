...
namespace Desktop___interfaces.Interfaces
{
    ...
    public partial class WindowCarListar : Window
    {
        ...
        {
            ListView.ItemsSource = SqlCar.GetAll(LIST_NULL, null, null, null, null, null, null, null, null,nPag, 10);
        ...
        private void RefreshListView()
        {
            ...
            ListView.ItemsSource = SqlCar.GetAll(listOrder, TextBoxFromDescri.Text, TextBoxUntilDescri.Text, TextBoxFromRepReq.Text, TextBoxUntilRepReq.Text, TextBoxFromPrice.Text, TextBoxUntilPrice.Text, TextBoxFromMaxSpeed.Text, TextBoxUntilMaxSpeed.Text, nPag, 10);    // Reassocia a listAlunos à ListView
        } 
