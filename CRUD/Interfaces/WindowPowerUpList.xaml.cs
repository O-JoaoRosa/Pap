...
namespace Desktop___interfaces.Interfaces
{
    ...
    public partial class WindowPowerUpList : Window
    {
        ...
        {
            ListView.ItemsSource = SqlPowerUp.GetAll(listOrder, null, null, nPag, 10);
        ...
        private void RefreshListView(int order)
        {
            ...
            ListView.ItemsSource = SqlPowerUp.GetAll(order, TextBoxFrom.Text, TextBoxUntil.Text, nPag, 10);    // Reassocia a listAlunos à ListView
        }
