...
namespace CRUD.ClassesEntidades.SQL
{
    class SqlCarBody
    {
        ...
        static public void Add(CarBody carBody)
        {
            ...
            try
            {
                ...
                using (DbConnection conn = OpenConnection())
                {
                    ...
                    using (MySqlCommand sqlCommand = ((MySqlConnection)conn).CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "INSERT INTO carBody"
                            + "(Descri,Price,Paint,CodeName)"
                            + "VALUES(@descri, @price, @paint, @codeName);";
                        sqlCommand.Parameters.Add(new MySqlParameter("@descri", carBody.Descri));
                        sqlCommand.Parameters.Add(new MySqlParameter("@price", carBody.Price));
                        sqlCommand.Parameters.Add(new MySqlParameter("@paint", carBody.Paint));
                        sqlCommand.Parameters.Add(new MySqlParameter("@codeName", carBody.CodeName));
        ...
        static public List<CarBody> GetAll(int order, string fromDescri, string untilDescri, string fromCodeName, string untilCodeName, int nPag, int nItens)
        {
                    ...
                    using (MySqlCommand sqlCommand = new MySqlCommand())
                    {
                        ...
                        using (MySqlDataReader reader = sqlCommand.ExecuteReader())
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                listaCarBodys.Add(carBody);       //adiciona o obj à lista
        ...
        static public CarBody Get(int id)
        {
        ...
        /// </summary>
        /// <param name="carBody">Objeto com id a alterar da tabela</param>
        static public void Set(CarBody carBody)
        {
            if (DEBUG_LOCAL)
            {
            ...
            try
            {
                ...
                using (DbConnection conn = OpenConnection())
                {
                    ...
                    {
                        sqlCommand.CommandType = CommandType.Text;
                        sqlCommand.CommandText = "UPDATE carBody SET "
                        + " Descri = @descri,"
                        + " CodeName = @codeName,"
                        + " Paint = @paint,"
                        + " Price = @price"
                        + " WHERE Id = @id;";
                        sqlCommand.Parameters.Add(new MySqlParameter("@id", carBody.Id));
                        sqlCommand.Parameters.Add(new MySqlParameter("@descri", carBody.Descri));
                        sqlCommand.Parameters.Add(new MySqlParameter("@codeName", carBody.CodeName));
                        sqlCommand.Parameters.Add(new MySqlParameter("@paint", carBody.Paint));
                        sqlCommand.Parameters.Add(new MySqlParameter("@price", carBody.Price));
        ...
        /// </summary>
        /// <param name="carBody">Objeto com id a apagar da tabela</param>
        static public void Del(CarBody carBody)
        {
            if (DEBUG_LOCAL)
            {
            ...
            try
            {
                ...
                using (DbConnection conn = OpenConnection())
                {
                    using (MySqlCommand sqlCommand = ((MySqlConnection)conn).CreateCommand())
                    {
                        // Prepara e executa o SQL DML
                        sqlCommand.CommandType = CommandType.Text;
                        sqlCommand.CommandText = "DELETE FROM carBody WHERE Id=@id;";
                        sqlCommand.Parameters.Add(new MySqlParameter("@id", carBody.Id));
        ...
        /// </summary>
        /// <param name="carBody">Registo a testar</param>
        /// <returns></returns>
        static public bool CheckRelationalIntegrityViolation(CarBody carBody)
        {
            if (DEBUG_LOCAL)
            {
