...
namespace Desktop___interfaces.ClassesEntidades.SQL
{
    class SqlServer
    {
        ...
        static public List<Server> GetAll(int order, string fromDescri, string untilDescri, 
            string fromCodeName, string untilCodeName, int nPag, int nItens)
        {
            ...
            try
            {
                ...
                using (DbConnection conn = OpenConnection())
                {
                    ...
                    if (fromDescri != null || untilDescri != null || 
                        fromCodeName != null || untilCodeName != null)
                    {
